...
<!-- RESERVATION PAGE ONLY FOR RESTAURANTS -->
...
<!-- ADDITIONAL STYLESHEET HERE -->
    ...
    <title>Reserve restaurant - RTH</title>
</head>
            ...
            <div class="row">
                <div class="col-md-12 p-0">
                    ...
                    <div class="about_us_reservation" style="margin-top: 85px">
                        <h1> RESERVATION FORM FOR RESTAURANTS </h1>
                    </div>
...
<!-- FORUM SECTION --> 
        ...
        <div class="row">
            ...
            <form action=" <?php echo URLROOT ?>/Reservations/restaurants" method= "POST">
                ...
                <div class="form-group row">
                    <label class="col-4 col-form-label">Select Restaurant</label>
                    <div class="col-8">
                        <select id="" name="res_name" class="form-control">
                            <option>--Select--</option>
                            <option>Pizza Lounge</option>
